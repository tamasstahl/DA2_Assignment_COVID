...
# covid data
cv <- read_csv(paste0(my_path,'raw/covid_09_08_2020_raw.csv'))
# population data
...
cv <- cv %>% select( -c( FIPS,Admin2,Last_Update,Lat,Long_,Recovered, Active, Combined_Key,Incidence_Rate,Case.Fatality_Ratio))
...
# Rename variables
cv2 <- cv2 %>% transmute( country   = Country_Region ,
...
my_path <- "C:/Users/ADMIN/Desktop/CEU/R_codes/Coding 1_Assignment 2/Assigment 2/data/"
# COVID data
write_csv( df , paste0(my_path,'clean/covid_pop_09_08_2020_clean_final.csv'))
